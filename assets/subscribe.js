...
(function () {
  ...
  function render(mount) {
    ...
    mount.innerHTML =
      '<h2>Get told when it launches</h2>' +
      '<p class="sub-lede">Robot Brawl is finished and waiting on App Store review. Leave your ' +
      'email and we will tell you the day it goes live — and, if you want it, who took each ' +
      ...
      '</form>' +
      '<div class="opts">' +
        '<label><input type="checkbox" name="updates" checked> Launch &amp; game updates</label>' +
      ...
      '<p class="fine">One email at launch, then only when a season ends. No ads, no tracking, ' +
